...
def test_bullet_vertical():
	#assumtion
	temp=bullet(10,20,BULLET_SHIP_SKINS[0],50,5,0,1,1)
...
def test_bullet_horizontal():
	#assumtion
	temp=bullet(10,20,BULLET_SHIP_SKINS[0],50,5,1,-1,1)
...
def test_off_screen():
        #assumtion
        temp = bullet(10,20,BULLET_SHIP_SKINS[0],50,5,0,1,1)
        temp2 = bullet(800,1000,BULLET_SHIP_SKINS[0],50,5,1,1,1)
        temp3 = bullet(10,1000,BULLET_SHIP_SKINS[0],50,5,1,1,1)
        temp4 = bullet(800,20,BULLET_SHIP_SKINS[0],50,5,1,1,1)
